...
export const MetricGrowth: React.FC<MotionLayerProps> = (props) => {
  ...
  return (
    <Panel accent="#65e7ff">
      ...
      <MicroLabel x={688} y={328} text={fit(props.targetOrDelta || props.baseline, '变化')} color="#ffd84f" size={40} />
      <div style={{position:'absolute',left:160,top:486,width:572,height:2,background:'rgba(255,255,255,.22)'}} />
    </Panel>
  );
};
