...
export const DensityPressure: React.FC<MotionLayerProps> = (props) => {
  ...
  return (
    <Panel accent="#65e7ff">
      <Card x={72} y={146} w={272} h={292} accent="#6eefff" p={left}><MicroLabel x={208} y={110} text="LIMIT" /><IconBlock accent="#6eefff" label={props.oldSolution || 'FAU'} /></Card>
      <MicroLabel x={446} y={64} text="PRESSURE" color="#ff5c7a" size={26} />
      ...
      <div style={{position: 'absolute', left: 430, top: 270, color: '#ff5c7a', fontSize: 96, opacity: pressure}}>›</div>
      <Card x={548} y={174} w={286 + 46 * expand} h={242} accent="#72ebcb" p={expand}><MicroLabel x={700} y={138} text="EXPAND" color="#72ebcb" size={24} /><IconBlock accent="#72ebcb" label={props.newSolution || 'GlassBridge'} /></Card>
